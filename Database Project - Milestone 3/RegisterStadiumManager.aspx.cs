...
namespace Database_Project___Milestone_3
{
    public partial class RegisterStadiumManager : System.Web.UI.Page
    {
        ...
        protected void register_button_click(object sender, EventArgs e)
        {
            ...
            String stadname = stadiumname1.Text;
            ...
            if (sname != null && sname != "" && !isNumeric(sname) && sname.Length <= 20 &&
                ...
                stadname != null && stadname != "" && !isNumeric(stadname) && stadname.Length <= 20)
            {
                SqlCommand registerproc = new SqlCommand("addStadiumManager", conn);
                registerproc.CommandType = System.Data.CommandType.StoredProcedure;

                registerproc.Parameters.Add(new SqlParameter("@name", sname));
                registerproc.Parameters.Add(new SqlParameter("@stname", stadname));
                ...
                {
                    Response.Write("Registration failed. Stadium name may not exist, or they may already be a manager for this stadium.");
                }
            }
            else
            {
